...
local function run(msg, matches)
  ...
  if matches[1] == "lista" then
    search = true
	 term = matches[2]
	 lang = nil
  elseif matches[2] == "lista" then
    search = true
	 term = matches[3]
	 lang = matches[1]
  else
